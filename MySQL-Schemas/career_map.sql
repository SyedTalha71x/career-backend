...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `increment_sort_on_insert` BEFORE INSERT ON `skills` FOR EACH ROW BEGIN
  DECLARE max_sort INT;

  SELECT COALESCE(MAX(sort), 0) INTO max_sort FROM skills;

  SET NEW.sort = max_sort + 1;
END */;;
DELIMITER ;
...
-- Dump completed on 2024-11-04 12:05:55
